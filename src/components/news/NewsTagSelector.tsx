      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            Select your interests (select 2+ for real-time results):
          </label>
          ...
          {selectedTags.length > 0 && (
            <div className="flex items-center justify-between pt-2">
              ...
              <button
                ...
                className="text-sm px-3 py-1 rounded bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-900 dark:text-red-200"
              >
                Clear All
              </button>
            </div>
        ...
        {/* Articles Display */}
        {selectedTags.length > 0 && !loading && articles.length > 0 && (
        ...
        {/* Empty State */}
        {selectedTags.length > 0 && !loading && articles.length === 0 && !error && (
          <div className="text-center py-8">
            <p className="text-gray-500 dark:text-gray-400">
              No articles found for {selectedTags.join(" AND ")}
            </p>
          </div>
        )}
        ...
        {selectedTags.length === 0 && (
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
            <p>👆 Select 2 or more tags to see relevant news</p>
          </div>
        )}
      </div>
    </ComponentCard>
